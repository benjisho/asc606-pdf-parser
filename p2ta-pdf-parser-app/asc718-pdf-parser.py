...
file_handler = logging.FileHandler('p2ta-pdf-parser-app/logs/asc718_pdf_parser.log')
...
def main():
    ...
    pdf_directory = os.path.join("pdf_files_to_parse", "asc718")  # Adjust for specific parser
