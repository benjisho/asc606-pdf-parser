...
file_handler = logging.FileHandler('p2ta-pdf-parser-app/logs/ifrs15_pdf_parser.log')
...
def main():
    ...
    pdf_directory = os.path.join("pdf_files_to_parse", "ifrs15")  # Adjust for specific parser
